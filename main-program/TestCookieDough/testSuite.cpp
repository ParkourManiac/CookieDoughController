...
void RunTests() 
{
	...
	RUN_TEST(CalculateAmountOfUnusedStorage_CalculatesTheAmountOfUnusedStorageAfterTheoreticallySavingTheGivenAmountOfKeymaps);
	RUN_TEST(CalculateAmountOfUnusedStorage_NoArguments_CalculatesTheUnusedStorageAsIfWeWereToSaveDownTheCustomKeyMaps);
	RUN_TEST(CalculateAmountOfUnusedStorage_NoArguments_ReturnsTheSameSizeAsIfWeWereToSaveKeymapsToMemory);
