...
void IsPacketOnEEPROMValid_PayloadLengthIsLargerThanTheEEPROM_ReturnsFalse();
...
void RunTests() 
{
	...
	RUN_TEST(IsPacketOnEEPROMValid_PayloadLengthIsLargerThanTheEEPROM_ReturnsFalse);
