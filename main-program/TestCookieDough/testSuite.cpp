...
void RunTests() 
{
	...
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_CorrectlyLoadsKeymapIntoList);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_CorrectlyLoadsKeymapIntoList_ReturnsTrue);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_LoadsKeymap_SetsCurrentPacketAdressToTheLoadedPacketsAdress);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_LoadsKeymap_SetsNextPacketAdressToAFreeAdressAfterTheEndOfTheLoadedPacket);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_LoadsKeymap_SetsTheAmountOfFreeStorageToBeEqualToTheStorageSizeMinusTheSizeOfTheLoadedPacket);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_GoesThroughWholeStorageWithoutFindingValidKeymaps_DoesNotRepeatInInfiniteLoop_AndReturnsFalse);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_OnlyOneInvalidKeymapInMemory_DoesNotAttemptToLoadTheSamePacketTwice_AndReturnsFalse);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_FailsToLoadKeymap_DoesNotChangeAmountOfFreeStorage);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_NoPacketInStorage_ReturnsFalse);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_LoadsKeymapThatExceedsTheEepromsLastAdress_DoesNotUpdateNextPacketAdressWithAnAdressOutsideTheEeprom);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_EepromHasDefectKeymaps_DoesNotLoadKeymaps);
	RUN_TEST(LoadKeymapsFromMemoryIntoListV2_EepromHasDefectKeymapsFollowedByValidKeymaps_LoadsTheValidKeymaps);
