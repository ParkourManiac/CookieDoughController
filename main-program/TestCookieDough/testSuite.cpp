...
void RunTests() 
{
	...
	RUN_TEST(ValidatePacketOnEEPROM_BeginsReadingAtTheAdress);
	RUN_TEST(IsPacketOnEEPROMValid_PacketIsValid_ReturnsTrue);
	RUN_TEST(ValidatePacketOnEEPROM_ReadsThePacketInACylicFormat);
	RUN_TEST(ValidatePacketOnEEPROM_AdressIsOutsideOfTheEEPROMsRange_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_CanNotFindStx_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_PacketIsDeactivated_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_PayloadLengthIsZero_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_PayloadLengthIsLargerThanTheEEPROM_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_CanNotFindEtx_ReturnsFalse);
	RUN_TEST(ValidatePacketOnEEPROM_CrcDoesNotMatchPayload_ReturnsFalse);
