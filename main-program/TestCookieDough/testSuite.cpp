...
void RunTests() 
{
	...
	RUN_TEST(SaveKeyMapsToMemory_PutsDownKeysAsBareKeyboardArrayIntoEEPROM);
	RUN_TEST(SaveKeyMapsToMemory_UpdatesNextFreeEepromAdressOfController);
	RUN_TEST(SaveKeyMapsToMemory_NextFreeEepromAdressIsSetToWeirdValue_UpdatesNextFreeEepromAdressOfControllerWithCorrectValue);
	...
	RUN_TEST(Helper_ParsePacketFromEEPROM_PrepareToReturnPacket_SetEepromSizeByHandToFitThePacket_ParsePacketFromEepromSuccessfullyReturnsCorrectPacket);
	RUN_TEST(Helper_ParsePacketFromEEPROM_PrepareToReturnPacket_UsingHighAdress_EepromLengthIsSetToFitPacket);
	RUN_TEST(Helper_ParsePacketFromEEPROM_PrepareToReturnPacket_SetEepromSizeByHandToNotFitThePacket_ParsePacketFromEEPROMFails);
	RUN_TEST(Helper_ParsePacketFromEEPROM_PrepareToReturnPacket_ParsePacketFromEepromRecievesInactiveFlag);
	RUN_TEST(Helper_SavePacketToEEPROM_PreparesEepromSizeAndPrepareToReturnPacket_SavePacketToEEPROMReturnsTrueAndReturnsCorrectPacketSize);
	RUN_TEST(Helper_SavePacketToEEPROM_PreparesEepromSizeAndPrepareToReturnPacket_SetEepromSizeByHandToNotFitPacket_ReturnsFalse);
	RUN_TEST(Helper_SavePacketToEEPROM_PreparesEepromSizeAndPrepareToReturnPacket_SetEepromSizeByHandToFitPacket_ReturnsTrue);
	RUN_TEST(Helper_SavePacketToEEPROM_PreparesEepromSizeAndPrepareToReturnPacket_WeProvideNoEepromSize_SetsEepromSizeAutomaticallyToFitOurPacket);
	RUN_TEST(Helper_SavePacketToEEPROM_PreparesEepromSizeAndPrepareToReturnPacket_UsingHighAdress_EepromLengthIsSetToFitPacket);
	...
	RUN_TEST(SavePacketToEEPROM_PacketWillExceedEndOfEEPROM_ReturnsCorrectPacketSize);
	RUN_TEST(SavePacketToEEPROM_PacketWillExceedEndOfEEPROM_SplitsPacketBetweenEndAndStartOfEEPROM);
	...
	RUN_TEST(SavePacketToEEPROM_AdressIsOutsideOfEEPROMsRange_ReturnsFalse);
	RUN_TEST(SavePacketToEEPROM_AdressIsOutsideOfEEPROMsRange_DoesNotWriteAnythingToEEPROM);
	RUN_TEST(ParsePacketFromEEPROM_DataPacketDoesNotNeedToBeManuallyAllocatedBeforePassedToFunciton_DoesNotCrash);
	RUN_TEST(ParsePacketFromEEPROM_ReturnsCorrectPacket);
	RUN_TEST(ParsePacketFromEEPROM_PacketIsSplitBetweenEndAndStartOfEEPROM_ReturnsCorrectPacketSize);
	RUN_TEST(ParsePacketFromEEPROM_PacketIsSplitBetweenEndAndStartOfEEPROM_SuccessfullyReadsPacket);
	RUN_TEST(ParsePacketFromEEPROM_ReturnsFalseWhenAValidPacketIsNotActive);
	RUN_TEST(ParsePacketFromEEPROM_ReturnsTrueWhenAValidPacketIsActive);
	RUN_TEST(ParsePacketFromEEPROM_EepromReturnsFaultyData_ReturnsFalse);
	RUN_TEST(ParsePacketFromEEPROM_AdressIsOutOfEEPROMsRange_ReturnsFalse);
