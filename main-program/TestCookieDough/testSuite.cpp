...
void FinishWritingPacket_PacketDoesNotFitOnEEPROM_SuccessIsFalseAndReturnsFalse();
...
void RunTests() 
{
	...
	RUN_TEST(FinishWritingPacket_PacketDoesNotFitOnEEPROM_SuccessIsFalseAndReturnsFalse);
