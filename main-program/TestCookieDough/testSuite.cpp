...
const char * Serial__print_param_a;
size_t Serial_::print(const char * a)
{
	Serial__print_param_a = a;
...
size_t Serial__print_return;
unsigned int Serial__print_invocations = 0;
unsigned char Serial__print_param_a;
int Serial__print_param_b;
size_t Serial_::print(unsigned char a, int b)
{
	Serial__print_param_a = a;
	Serial__print_param_b = b;
	Serial__print_invocations++;
	return Serial__print_return;
}
...
size_t Serial__print_return;
unsigned int Serial__print_invocations = 0;
unsigned int Serial__print_param_a;
int Serial__print_param_b;
...
size_t Serial__print_return;
unsigned int Serial__print_invocations = 0;
unsigned long Serial__print_param_a;
int Serial__print_param_b;
...
size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
const char * Serial__println_param_a;
size_t Serial_::println(const char * a)
{
	Serial__println_param_a = a;
	Serial__println_invocations++;
	return Serial__println_return;
}

size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
char Serial__println_param_b;
size_t Serial_::println(char b)
{
	Serial__println_param_b = b;
	Serial__println_invocations++;
	return Serial__println_return;
}
...
size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
unsigned char Serial__println_param_a;
int Serial__println_param_b;
...
size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
unsigned int Serial__println_param_a;
int Serial__println_param_b;
...
size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
unsigned long Serial__println_param_a;
int Serial__println_param_b;
...
size_t Serial__println_return;
unsigned int Serial__println_invocations = 0;
double Serial__println_param_a;
int Serial__println_param_b;
...
void ResetMocks() 
{
	...
	delay_param_ms = long();
	delay_invocations = 0;
	Serial__print_param_a = nullptr;
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__print_param_a = char();
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__print_param_a = char();
	Serial__print_param_b = int();
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__print_param_a = int();
	Serial__print_param_b = int();
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__print_param_a = int();
	...
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__print_param_a = double();
	Serial__print_param_b = int();
	Serial__print_invocations = 0;
	Serial__print_return = size_t();
	Serial__println_param_a = nullptr;
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_param_b = char();
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_param_a = char();
	Serial__println_param_b = int();
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_param_a = int();
	Serial__println_param_b = int();
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_param_a = int();
	...
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_param_a = double();
	Serial__println_param_b = int();
	Serial__println_invocations = 0;
	Serial__println_return = size_t();
	Serial__println_invocations = 0;
