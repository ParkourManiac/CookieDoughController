...
void ChangeKeyMap_EquipsTheDefaultKeymap_isUsingDefaultKeymapIsAssignedTrue();
void ChangeKeyMap_EquipsCustomKeymap_isUsingDefaultKeymapIsAssignedFalse();
void ChangeKeyMap_CustomKeymapWithSimilarButNotTheSameSettingsAsDefaultKeymapIsEquipped_isUsingDefaultKeymapIsAssignedFalse();
...
void SpecialKeyConstructor_IntializesPinAndKeycodeCorrectly();
...
void RunTests() 
{
	...
	RUN_TEST(ChangeKeyMap_EquipsTheDefaultKeymap_isUsingDefaultKeymapIsAssignedTrue);
	RUN_TEST(ChangeKeyMap_EquipsCustomKeymap_isUsingDefaultKeymapIsAssignedFalse);
	RUN_TEST(ChangeKeyMap_CustomKeymapWithSimilarButNotTheSameSettingsAsDefaultKeymapIsEquipped_isUsingDefaultKeymapIsAssignedFalse);
	...
	RUN_TEST(SpecialKeyConstructor_IntializesPinAndKeycodeCorrectly);
